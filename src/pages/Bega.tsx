        ...
        <div className="w-full lg:w-1/2">
          <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-orange-100">
            <h1 className="text-2xl lg:text-4xl text-gray-900 font-amharic font-bold mb-2">
              የ2019 ዓ.ም. መደበኛ የበጋ ኮርስ ምዝገባ
            </h1>
            <p className="text-sm lg:text-base text-gray-600 font-amharic font-light mb-2">
              በ2019 ዓ.ም. የበጋ ላይ የቤተ ክርስቲያን ትምህርትን ደብረ ይድራስ ቅዱስ ጊዮርጊስ ቤተ ክርስቲያን ተገኝተው መማር ለሚፈልጉ ሰዎች መመዝገቢያ ቅጽ
            </p>
